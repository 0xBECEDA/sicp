...
/*               bind_proc_name_and_proc_fn( "=", "equal_numbers_predicate" ), */
...
/*               bind_proc_name_and_proc_fn( "print", "ipprint") */
/*               ); */
/* } */
...
int main () {
    ...
    /* printf("primitives_objects\n"); */
    /* ipprint( primitives_objects ); */
    /* printf("\n"); */

    /* printf("primitives_names\n"); */
    /* ipprint( primitives_names ); */
    /* printf("\n"); */
