...
int num_str_predicate(char* symbol_str) {
    if( ( symbol_str[0] == '-' &&  symbol_str[1] == '1') ||
        ( symbol_str[0] == '-' &&  symbol_str[1] == '2') ||
        ( symbol_str[0] == '-' &&  symbol_str[1] == '3') ||
        ( symbol_str[0] == '-' &&  symbol_str[1] == '4') ||
        ( symbol_str[0] == '-' &&  symbol_str[1] == '5') ||
        ( symbol_str[0] == '-' &&  symbol_str[1] == '6') ||
        ( symbol_str[0] == '-' &&  symbol_str[1] == '7') ||
        ( symbol_str[0] == '-' &&  symbol_str[1] == '8') ||
        ( symbol_str[0] == '-' &&  symbol_str[1] == '9') ||
        symbol_str[0] == '0' ||
        symbol_str[0] == '1' ||
        symbol_str[0] == '2' ||
        symbol_str[0] == '3' ||
