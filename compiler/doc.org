...
это функция определена в test.c и нужна, чтоб установить глобальные
...
"gcc test.c your-file-name.c -o name"

~test.c~ - это файл, в котором определены все примитивы в сишном
эквиваленте.
