...
#+NAME: list_string
#+BEGIN_SRC scheme :noweb yes
  ;; превращает выражение в список токенов, каждый из которых является строкой
  ;; (define (list->string-tokens lst)
  ;;   (define (rec-list->tokens lst retval)
  ;;     ;; (display "lst")
  ;;     ;; (display lst)
  ;;     ;; (newline)
  ;;     ;; (display "retval")
  ...
  ;;               ;; (display "car pair")
  ;;               ;; (newline)
  ;;               (let (( result (append (rec-list->tokens (car lst) (list "("))
  ;;                                      (rec-list->tokens (cdr lst) '()))))
  ;;                 ;; (newline)
  ;;                 ;; (display "result")
  ;;                 ;; (display result)
  ;;                 ;; (newline)
  ;;                 (append retval result)))
  ;;               (cond ((symbol? (car lst)) (rec-list->tokens (cdr lst)
  ;;                                                            (append retval
  ;;                                                                    (list
  ;;                                                                     (symbol->string
  ;;                                                                      (car lst))))))
  ;;                     ((number? (car lst)) (rec-list->tokens (cdr lst)
  ;;                                                            (append retval
  ;;                                                                    (list
  ;;                                                                     (number->string
  ;;                                                                      (car lst))))))
  ;;                     (else (rec-list->tokens (cdr lst)
  ;;                                             (append retval
  ;;                                                      (list "string" (car lst)))))))))
  ...
  ;; (list->string-tokens '(1 2 3))

  ;; (list->string-tokens '(lambda (x) (+ x 1)))

  ;; (list->string-tokens '(define (factorial n)
  ;;                         (if (= n 0)
  ;;                             1
  ;;                             (* n (factorial (= n 1))))))

  ;; (list->string-tokens '(let ((a 3)
  ;;                             (b 4))
  ;;                         (+ 1 a b)))

  ;; (list->string-tokens '(1 2 "2"))

  ;; (list->string-tokens '(1 2 "(+ 1 2 )"))
...
#+BEGIN_SRC scheme :noweb yes
  ...
  ;;   (define (transform-exp-rec exp string)
  ;;     (if (null? exp)
  ;;         string
  ...
  ;;                                                           (symbol->string
  ;;                                                            first-elt))))))))))
  ;;   (transform-exp-rec exp ""))

  ;; (define (compiled-code->string code)
  ;;   (define (rec-compiled-code->string code string)
  ;;     (if ( null? code )
  ;;         string
  ;;         (begin
  ;;           (string-append string (transform-exp (car code))
  ;;                          (compiled-code->string (cdr code))))))
