...
#+BEGIN_SRC scheme :noweb yes
  (define (compile-strings strings-list)
    (define (rec-compile-string strings-list compiled-code)
  ...
  (define (compile-symbols symbols-list strings)
    ...
    (rec-compile-symbols symbols-list strings '()))

  ;; (print-code (transform-exp
  ;;              (compile-symbols '("a" "b" "c") '("\"a-string\""
  ;;                                                "\"b-string\""
  ;;                                                "\"c-string\""))))

  ;; (print-code (transform-exp
  ;;              (compile-strings  '("\"a-string\""
  ;;                                  "\"b-string\""
  ;;                                  "\"c-string\""))))
#+END_SRC
