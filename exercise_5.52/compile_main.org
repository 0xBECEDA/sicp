...
#+BEGIN_SRC scheme :noweb yes
  ...
  ;; (print-code (compiled-code->string (compile '(if (= n 0)
  ;;                                                  "true"
  ...
  (print-code (compiled-code->string
               (compile
                '(define (test x)
                   (if (= x 0)
                       "true"
                       (test (- x 1)))) global-environment)))

  ;; (print-code (compiled-code->string
  ;;              (compile
  ;;               '(define n 10) global-environment)))

  ;; (print-code (compiled-code->string
  ;;              (compile
  ;;               '(test (+ n 10)) global-environment)))
#+END_SRC
